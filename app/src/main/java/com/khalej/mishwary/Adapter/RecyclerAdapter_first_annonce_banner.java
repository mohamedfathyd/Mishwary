...
public class RecyclerAdapter_first_annonce_banner extends RecyclerView.Adapter<RecyclerAdapter_first_annonce_banner.MyViewHolder> {
    ...
    public RecyclerAdapter_first_annonce_banner(Context context, List<contact_annonce> contactslist, RecyclerView recyclerView){
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Glide.with(context).load("http://applicationme.com/maishwary/public/storage/uploads/"+contactslist.get(position).getImage()).error(R.drawable.logo).into(img);
                settingsDialog.show();
            }
